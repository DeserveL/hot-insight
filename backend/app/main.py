...
def runtime_config_summary(config: AppConfig, scheduler_enabled: bool) -> dict[str, object]:
    return {
        ...
        "weibo_mobile_enabled": config.weibo_mobile_enabled,
        "weibo_mobile_timeout_seconds": config.weibo_mobile_timeout_seconds,
        "weibo_mobile_max_posts": config.weibo_mobile_max_posts,
